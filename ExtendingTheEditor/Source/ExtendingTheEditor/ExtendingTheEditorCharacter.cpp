...
//////////////////////////////////////////////////////////////////////////
// AExtendingTheEditorCharacter

AExtendingTheEditorCharacter::AExtendingTheEditorCharacter()
{
...
void AExtendingTheEditorCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AExtendingTheEditorCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AExtendingTheEditorCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AExtendingTheEditorCharacter::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void AExtendingTheEditorCharacter::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AExtendingTheEditorCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AExtendingTheEditorCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
